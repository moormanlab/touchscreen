...
4 of 650
Touchscreen menu update Feb 15
Inbox

Rupak Poddar
AttachmentsFeb 15, 2022, 8:07 PM (13 days ago)
Hello guys, I have attached the py file with working multiple attachments feature and also the file list gets recreated on clicking the "send file" button.

Alex Kramer
AttachmentsFeb 15, 2022, 10:09 PM (13 days ago)
Here is the updated Menu file with email validation.

Neil Wei
AttachmentsFeb 23, 2022, 12:43 AM (5 days ago)
Hey, Here's the code put together

Rupak Poddar
Attachments
Feb 24, 2022, 7:29 PM (4 days ago)
to me, Alex

Hi,

I have made some changes to the code. Please test it out on your machine. The changes are as follows-
1. Added a new option for viewing the attached files.
2. The warning window now has a red theme.
3. The code checks if the selected file is already added in the list.
4. You get an error message if you click "send" without selecting any file.
...
Attachments area
Got it, thanks!Got it.Thanks, I'll take a look.
#!/usr/bin/python3
